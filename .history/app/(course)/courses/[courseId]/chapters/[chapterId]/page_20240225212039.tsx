...
const ChapterPage = async ({
  ...
  const validCompletedChapters = await UserProgress.countDocuments({userId: userId, chapterId: {$in: {publishedChapterIds}}, isPublished: true})
  ...
  console.log(publishedChapterIds)
