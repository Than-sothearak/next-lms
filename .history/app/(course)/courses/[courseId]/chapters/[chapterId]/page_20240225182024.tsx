...
const ChapterPage = async ({
  ...
  const course = await Course.findById({_id: courseId, userId: userId})
  ...
  const userProgress =await UserProgress.findById({userId: userId, chapterId: chapterId})
  const nextChapter = await Chapter.findById({courseId: courseId, isPublished: true}).sort({position: -1})
