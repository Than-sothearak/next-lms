    ...
    <div className="mt-6 border bg-slate-100 rounded-md p-4">
      ...
      {isEidting && (
        <div className="h-60 bg-slate-100 p-4 border-2">
          <div className="h-full gap-x-10 text-xs text-center text-muted-foreground justify-center items-center">
            <div className="flex flex-cols"><Upload /> <p>16:0 aspect ratio recommend</p></div>
